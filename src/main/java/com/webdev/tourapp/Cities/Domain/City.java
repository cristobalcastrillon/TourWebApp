...
public class City
{
    ...
    public City(CityID id, CityName name, CityDefaultIATA iata, Optional<ArrayList<Location>> locationsInCity, Optional<ArrayList<Tour>> tours) {
        this.id = id;
        this.name = name;
        this.iata = iata;
    ...
    public static City Create(CityID id, CityName name, CityDefaultIATA iata, ArrayList<Location> locationsInCity, ArrayList<Tour> tours){
        City city = new City(id, name, iata, Optional.ofNullable(locationsInCity),Optional.ofNullable(tours));
